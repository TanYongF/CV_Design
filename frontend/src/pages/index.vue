<template>
  <div>
        ...
        <el-col :lg="20" :md="24" style="margin-bottom: 0px !important">
          <el-descriptions>
            ...
            <el-descriptions-item label="手机号">
              {{ $store.state.user.phone }}</el-descriptions-item
            >
            <el-descriptions-item label="昵称">
              {{ $store.state.user.nickname }}
            </el-descriptions-item>
            <el-descriptions-item label="性别">{{
              $store.state.user.gender ? "男" : "女"
            }}</el-descriptions-item>
    ...
    <!-- 统计开始 -->
    <div class="detail-title">简历统计</div>
    <el-row :gutter="20">
      <el-col :lg="6" :md="24" :sm="24" :offset="0">
        <el-card shadow="never">
          ...
          <div class="card-count">
            <CountTo :value="statistics.value.resumeCount"> </CountTo>
          </div>
          <!-- card body -->
        </el-card>
      </el-col>
        ...
        <el-card shadow="never">
          <template #header>
            <div class="flex">
              <span> 标签总数 </span>
              <span class="ml-auto">
                <el-tag type="warning" size="normal" effect="light"
                  >全部</el-tag
                >
              </span>
            </div>
        ...
        <el-card shadow="never">
          <template #header>
            <div class="flex">
              <span> 岗位总数 </span>
              <span class="ml-auto">
                <el-tag type="success" size="normal" effect="light"
                  >全部</el-tag
                >
              </span>
            </div>
    ...
    <!--  简历分析开始  -->
    <div class="detail-title">简历分析</div>
    <el-row :gutter="15">
      <el-col :lg="8" :md="12" :sm="24" :offset="0">
        <IndexChart
          :chartData="statistics.value.ages"
          v-if="flag"
          :chartId="123"
          chartTitle="年龄分布扇形图"
        ></IndexChart>
      ...
      <el-col :lg="8" :md="12" :sm="24" :offset="0">
        <IndexChart
          :chartData="statistics.value.schools"
          v-if="flag"
          :chartId="124"
          chartTitle="学校分布扇形图"
        >
      ...
      <el-col :lg="8" :md="12" :sm="24" :offset="0">
        <IndexChart
          :chartData="statistics.value.genders"
          v-if="flag"
          :chartId="125"
          chartTitle="性别分布扇形图"
        >
