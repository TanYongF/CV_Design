    ...
    <div>
        ...
        <el-form inline :model="searchCondition"  :default-sort="{ prop: 'updateAt', order: 'descending' }">
            ...
            <el-form-item label="工作年限">
                <el-input placeholder="任意最低工作年限" v-model="searchCondition.minWorkYears"></el-input>
            </el-form-item>
            <el-form-item>
                <el-button type="primary" @click="handlePageChange(1)">搜索</el-button>
                <el-button type="primary" @click="dialogVisible = true" v-if="$store.state.user.role == 1">新增</el-button>
            </el-form-item>
        </el-form>
        ...
        <el-table border class="w-full" stripe fit :data="jobs" v-loading="loading"
            ...
            <el-table-column label="操作">
                <template #default="scope">
                    <el-button type="primary" @click="handleDetailUpdate(scope.row.id)">更新</el-button>
                    <el-button type="danger" @click="handleDelete(scope.$index, scope.row.id)">删除</el-button>
                    <el-button type="success" @click="handlePropose(scope.row.id)">匹配人选</el-button>
                </template>
            </el-table-column>
        </el-table>
