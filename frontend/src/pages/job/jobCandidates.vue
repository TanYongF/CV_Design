    ...
    <el-col :span="24" :offset="0">
      <div class="mb-4">
        <el-page-header
          :icon="ArrowLeft"
          class="mr-0"
          @back="$router.push('/job/my')"
        >
          <template #content>
            <div class="flex items-center">
              <span class="font-600 text-14px mr-3">
                {{ job.value.positionName }}推荐候选人
              </span>
            </div>
          </template>
        </el-page-header>
  ...
  <div v-cloak>
    <div v-if="candidates.length == 0">
      <el-empty description="该岗位暂无候选人推荐" :image-size="screenHeight">
        <el-button type="primary" @click="$router.push('/job/my')"
          >返回</el-button
        >
      </el-empty>
    </div>
      ...
      <el-row justify="center">
        <el-col :span="24">
          ...
          >
            ...
            ></el-table-column>
            <el-table-column
              prop="key.highestDegree"
              width="100px"
              :formatter="highestDegreeFormatter"
              label="最高学历"
            >
            </el-table-column>
            <el-table-column
            ...
            <el-table-column
              prop="key.workingYears"
              width="100px"
              :formatter="workingYearsFormatter"
              label="工作年限"
            ></el-table-column>
            <el-table-column
              prop="key.intention"
