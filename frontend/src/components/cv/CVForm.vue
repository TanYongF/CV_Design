<template>
  ...
  >
    ...
    <el-form-item label="基本信息">
      ...
      <el-col :span="1" class="inline-form justify-center items-center flex"
        ><span class="text-gray-300">-</span></el-col
      >
      <el-col :span="8">
        <el-form-item class="inline-form" prop="highestDegree" required>
          <el-select
            v-model="cv.highestDegree"
            placeholder="请选择最高学历"
            class="w-full"
          >
      ...
      <el-col :span="8">
        <el-form-item prop="politicalAppearance" required class="inline-form">
          <el-select
            v-model="cv.politicalAppearance"
            placeholder="请选择政治面貌"
            class="w-full"
          >
    ...
    <el-form-item label="最后毕业学校" required prop="school">
      <el-input
        v-model="cv.school"
        placeholder="一般情况下，这里是你最高学历就读学校"
      ></el-input>
    </el-form-item>
    ...
    <el-form-item label="自我介绍">
      <el-input
        v-model="cv.selfEvaluation"
        type="textarea"
        placeholder="个人简介，包括兴趣等等"
      ></el-input>
    </el-form-item>
...
const rules = {
  ...
  intention: [{ required: true, trigger: "blur" }],
