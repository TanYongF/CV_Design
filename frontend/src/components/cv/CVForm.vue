<template>
    <el-form :model="cv" labe="right" label-width="auto" size="large" class="mx-auto" style="width:95%">
        ...
        <el-form-item label="基本信息">
            <el-col :span="6" class="mb-0" style="padding: 0;">
                <el-select v-model="cv.gender" placeholder="您的性别" class="w-full px-0">
            ...
            <el-col :span="1" class="mb-0 justify-center items-center flex"><span class="text-gray-300">-</span></el-col>
            ...
            <el-col :span="1" class="mb-0 justify-center items-center flex"><span class="text-gray-300">-</span></el-col>
            <el-col :span="8" class="mb-0" style="padding: 0;">
...
const props = defineProps(['cv', 'showButton'])
