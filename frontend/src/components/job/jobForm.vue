    ...
    <el-form label-width="auto">
        ...
        <el-form-item label="工资薪水">
            <el-col :span="11" class="mb-0">
                <el-input-number v-model="job.minSalary" placeholder="最低薪酬" style="width: 100%" />
            </el-col>
            <el-col :span="2" class="text-center mb-0" >
                <span class="text-gray-500">-</span>
            </el-col>
            <el-col :span="11" class="mb-0" >
                <el-input-number v-model="job.maxSalary" placeholder="最高薪酬" style="width: 100%" />
            </el-col>
        </el-form-item>
        <el-form-item label="最低要求学历">
            <el-select v-model="job.minDegree" placeholder="候选人最低要求学历" class="w-full">
        ...
        <el-form-item label="最低工作年限">
            <el-input v-model="job.minWorkYears" placeholder="候选人最低要求工作年限"></el-input>
        </el-form-item>
